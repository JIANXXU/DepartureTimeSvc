...
* Location is curated and stored in a local file based database.  Currently only two BART stations are in the database.
...
* services/serializers.py - defines serializers that transform data model to REST response or vice versa.
